 ...
 ## Overview
 This document contains exploratory testing sessions notes, usability observations, and UX insights discovered while testing the Restful Booker Platform (`https://automationintesting.online/`).
 * **Environment:** Google Chrome, Windows 11, 1920x1080
